...
import rajaMark from '../assets/raja-mark.svg';
...
export function CtaBand({ go }) { return <section className="cta-band"><div><div className="cta-kicker-row"><img src={rajaMark} alt="" /><small className="section-kicker">Let's build better</small></div><h2>Have a requirement?<br />We are ready to help.</h2><p>Speak with our product specialists for quotes, bulk orders and technical guidance.</p></div><Btn onClick={() => go('contactus')}>Request a quote <ArrowRight size={15} /></Btn></section>; }
